<%@page language="java" import="AdminFunctionalities.*,AccountFunctionalities.*"%>
...
<form method="post" action="AdminEditUser.jsp" name="Edit">
    ...
    <input name="Username" value=<% out.println(afc.viewUsers().get(i).getEmail()); %> type="hidden">
</form>
</td>
<td style="vertical-align: top;"><%out.println(afc.viewUsers().get(i).getFirstName());%>
</td>
<td style="vertical-align: top;"><%out.println(afc.viewUsers().get(i).getEmail());%>
</td>
<td style="vertical-align: top;"><%out.println(afc.viewUsers().get(i).getPassword());%>
</td>
<td style="vertical-align: top;"><%out.println(afc.viewUsers().get(i).getType());%>
</td>
<td style="vertical-align: top;"><%out.println(afc.viewUsers().get(i).getStatus());%>
</td>
<td style="vertical-align: top;">
